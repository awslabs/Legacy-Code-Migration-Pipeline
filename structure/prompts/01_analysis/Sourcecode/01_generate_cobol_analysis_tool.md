...
## Objective
Analyze COBOL legacy source code. Understand structure, dependencies, and flows. Generate comprehensive dependency analysis, module classifications, end-to-end flow identification, and business domain assignments to support migration planning. Make use of preexisting tools if available or create them.
