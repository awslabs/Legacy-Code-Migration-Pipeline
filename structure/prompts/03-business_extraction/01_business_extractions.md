...
# Phase 3: Business Specification Extraction - Complete Workflow

---

## Overview

This phase extracts business requirements from legacy code through a three-step process:
1. **Phase 3.0**: Business Context Discovery - Understand the business domain and intent
...
**Task File Name**: {{TASKS_BASE_PATH}}/business_context_discovery_task.md
...
- **Objective section**: Discover business context before extracting technical details
- **Detailed instructions**: All Steps 1-8 below
- **Business rules and constraints**: Focus on business understanding, not technical extraction
- **Error handling guidance**: Missing documentation, ambiguous business domain, conflicting stakeholder information
- **Output format requirements**: Business context documents, business glossary
- **Quality criteria**: Business domain clarity, stakeholder completeness, vocabulary accuracy
...
- **All output locations** (resolved paths):
  - Business context documents: {{BUSINESS_CONTEXT_BASE_PATH}}
...
- **Agent name**: business_context_analyst
- **Agent definition file**: structure/agents/business_team/business_context_analyst.md
- **Note**: Don't duplicate agent definition, just reference it

### 4. Dependencies from previous phases:
...
**Task File Name**: {{TASKS_BASE_PATH}}/business_specification_extraction_task.md
...
1. **Business Specification Documents**
   ...
   - Description: IEEE 830-1998 formatted business specifications for each workpackage flow
...
- [ ] All business entities extracted and documented at business concept level
- [ ] All business rules identified and cataloged (distinguished from technical rules)
- [ ] All business functions and processes specified
- [ ] IEEE 830-1998 standard compliance verified
- [ ] Technology-agnostic documentation achieved (Chapters 1-9)
- [ ] Legacy implementation references complete (Chapter 10)
...
- **Detailed instructions**: All Steps 1-12 below
...
- **Input Locations**:
  ...
  - Legacy framework documentation: `{{PROJECT_BASE_PATH}}/input